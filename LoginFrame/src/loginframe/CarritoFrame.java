 ...
 * Muestra las pizzas agregadas al carrito y permite eliminar, modificar o finalizar la compra.
 * 
...
public class CarritoFrame extends javax.swing.JFrame {
    ...
    /**
    * Constructor de la clase CarritoFrame.
    * Inicializa los componentes de la interfaz gráfica y establece la posición de la ventana
    * en el centro de la pantalla. Además, asigna el menú principal y carga la lista de pizzas
    * en el carrito para su visualización.
    */
    public CarritoFrame() {
        initComponents();
...
/**
 * Este método se encarga de cargar las pizzas almacenadas en el carrito 
 * y mostrarlas en la tabla de la interfaz gráfica. 
 * 
 * Se recorre la lista de pizzas y se añaden al modelo de la tabla, 
 * garantizando que las celdas no se puedan editar. 
 * 
 * Para lograrlo, se utiliza un {@link DefaultTableModel} personalizado 
 * que impide la edición de las celdas. Antes de añadir las nuevas 
 * filas, se limpia la tabla para evitar que se dupliquen los datos.
 * 
...
private void cargarPizzasEnCarrito() {
     ...
     * Se cierra la ventana del carrito y vuelve al menú principal.
     * 
     ...
     * Elimina la pizza que fue seleccionada del carrito de compras(mis pedidos pendientes).
     * 
     * @param evt El evento de acción que dispara este método.
     */
 ...
 */
    ...
    /**
     * Metodo principal que ejecutar la clase CarritoFrame
